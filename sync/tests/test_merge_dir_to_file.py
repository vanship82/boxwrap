...
''' Test TO_FILE cases, which is treated as DELETED
'''
class TestMergeDirToFile(unittest.TestCase):
  ...
  def testModifyToFile(self):
    f = open(os.path.join(self.test_dir1_level1, _TEST_CASE_FILE1), 'w')
    f.write('modified1')
    f.close()
    shutil.rmtree(self.test_dir2_level1)
    f = open(self.test_dir2_level1, 'w')
    f.write('to_file')
    f.close()
  ...
  def testToFileModify(self):
    shutil.rmtree(self.test_dir1_level1)
    f = open(self.test_dir1_level1, 'w')
    f.write('to_file')
    f.close()
    f = open(os.path.join(self.test_dir2_level1, _TEST_CASE_FILE1), 'w')
    f.write('modified2')
  ...
  def testToFileNoChangeNoConflict(self):
    shutil.rmtree(self.test_dir1_level1)
    f = open(self.test_dir1_level1, 'w')
    f.write('to_file')
    f.close()
  ...
  def testNoChangeToFileNoConflict(self):
    shutil.rmtree(self.test_dir2_level1)
    f = open(self.test_dir2_level1, 'w')
    f.write('to_file')
    f.close()

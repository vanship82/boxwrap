...
''' Test TO_DIR cases, which is treated as DELETED
'''
class TestMergeFileToDir(unittest.TestCase):
  ...
  def testSyncToDirLeft(self):
    os.remove(os.path.join(_TEST_DIR1, _TEST_CASE_FILE))
    os.mkdir(os.path.join(_TEST_DIR1, _TEST_CASE_FILE))
    f = open(
        os.path.join(
            _TEST_DIR1, os.path.join(_TEST_CASE_FILE, _TEST_CASE_FILE_NEW)),
        'w')
    f.write('new')
    f.close()
  ...
  def testSyncToDirRight(self):
    os.remove(os.path.join(_TEST_DIR2, _TEST_CASE_FILE))
    os.mkdir(os.path.join(_TEST_DIR2, _TEST_CASE_FILE))
    f = open(
        os.path.join(
            _TEST_DIR2, os.path.join(_TEST_CASE_FILE, _TEST_CASE_FILE_NEW)),
        'w')
    f.write('new')
    f.close()
  ...
  def testSyncToDirLeftModifyRight(self):
    os.remove(os.path.join(_TEST_DIR1, _TEST_CASE_FILE))
    os.mkdir(os.path.join(_TEST_DIR1, _TEST_CASE_FILE))
    f = open(
        os.path.join(
